...
public abstract class TiledeskSplashActivity extends AppCompatActivity {
...
//    protected abstract Intent getLoginIntent();
    ...
    final protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(DEBUG_LOGIN, "TiledeskSplashActivity.onCreate");
...
//        FirebaseUser currentUser = mAuth.getCurrentUser();
    ...
    final protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d(DEBUG_LOGIN, "TiledeskSplashActivity.onActivityResult: requestCode == " + requestCode + " resultCode == " + requestCode);
    ...
    private void runDispatch() {
        Log.d(DEBUG_LOGIN, "TiledeskSplashActivity.runDispatch");
        // If current user has already logged in launch the target activity,
        // else launch the login activity
        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
            Log.d(DEBUG_LOGIN, "TiledeskSplashActivity.runDispatch: user is logged in. Goto : " + getTargetClass().getName());
            ...
            Log.d(DEBUG_LOGIN, "TiledeskSplashActivity.runDispatch: user is not logged in. Goto  TiledeskLoginActivity");
            // Send user to login activity
//            startActivityForResult(getLoginIntent(), LOGIN_REQUEST);
            startActivityForResult(new Intent(this, TiledeskLoginActivity.class), LOGIN_REQUEST);
        }
    }
}