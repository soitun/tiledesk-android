package tiledesk.android.authentication.task;
...
public class TiledeskGetCustomTokenTask extends AsyncTask<Object, Void, String> {
    private static final String TAG = TiledeskGetCustomTokenTask.class.getName();
    private OnCustomAuthTokenCallback onCustomAuthTokenCallback;
    private Exception mException;// fix Issue #24

    public TiledeskGetCustomTokenTask(OnCustomAuthTokenCallback onCustomAuthTokenCallback) {
        Log.d(TAG, "TiledeskGetCustomTokenTask");
...
//                conn.setRequestProperty("Accept-Language", ChatUtils.getLanguage());
            ...
            postDataParams.add(new BasicNameValuePair("email", email));
            postDataParams.add(new BasicNameValuePair("password", password));
...
//            tiledeskOnCustomAuthTokenCallback.onCustomAuthRetrievedWithError(
